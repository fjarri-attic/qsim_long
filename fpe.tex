...
\begin{eqn}
    N \gg M,
\end{eqn}
where $N$ is the number of atoms and $M \equiv |L|$ is the size of the restricted mode subset.
...
\begin{eqn}
	Q_{\lvec} = \sum_{\nvec \in L \cup H} \phi_j Z_{\lvec,\nvec},
\end{eqn}
and $Z_{\lvec,\nvec}$ is, in turn, a complex-valued Wiener process.
