...
\begin{equation}\label{eqn:master-eqn:commutators}\begin{split}
...
\begin{equation}\label{eqn:master-eqn:hamiltonian}\begin{split}
    \hat{H}
...
\begin{equation}\label{eqn:master-eqn:single-particle}\begin{split}
    K_{jk} = \left(
...
\begin{equation}\label{eqn:master-eqn:effective-H}\begin{split}
    \hat{H}
    = \int d\boldsymbol{x} \left\{
        \hat{\Psi}_j^{\dagger} K_{jk} \hat{\Psi}_k
...
\begin{equation}\label{eqn:master-eqn:master-eqn}\begin{split}
    \frac{d\hat{\rho}}{dt} =
...
\begin{equation}\label{eqn:master-eqn:loss-term}\begin{split}
    \mathcal{L}_{\boldsymbol{l}} \left[ \hat{\rho} \right] =
