...
In order to write equations in terms of wavefunctions and field operators instead of mode populations and operators, we will need to use the functional calculus.
...
First, we must introduce some operations on functions, which will extend differentials and integration from the previous section.
